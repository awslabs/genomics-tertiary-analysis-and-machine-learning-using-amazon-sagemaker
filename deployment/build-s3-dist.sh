...
cp $source_dir/setup_cfn.yml $template_dir/genomics-tertiary-analysis-and-machine-learning-using-amazon-sagemaker.template
...
cd $source_dir/GenomicsLearningCode/setup
